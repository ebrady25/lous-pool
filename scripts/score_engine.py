...
FORCE_EVENT_NAME = "Wyndham Championship"
FORCE_COURSE_PAR = 70  # Sedgefield CC, Greensboro NC (par 70 tournament setup, 7131 yds)
FORCE_COURSE_NAME = "Sedgefield"  # shown top-right on leaderboard
...
def process_tournament(live_data, inplay_data=None):
    ...
    WD_OVERRIDES = {
        # Week 15 - Wyndham Championship: No WDs yet
    }
