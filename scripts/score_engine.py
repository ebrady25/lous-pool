...
FORCE_EVENT_NAME = "U.S. Open"
FORCE_COURSE_PAR = 70  # Shinnecock Hills, Southampton NY (par 70, 7434 yds)
FORCE_COURSE_NAME = "Shinnecock"  # shown top-right on leaderboard
