...
FORCE_EVENT_NAME = "John Deere Classic"
FORCE_COURSE_PAR = 71  # TPC Deere Run, Silvis IL (par 71, 7327 yds)
FORCE_COURSE_NAME = "TPC Deere Run"  # shown top-right on leaderboard
...
def process_tournament(live_data, inplay_data=None):
    ...
    WD_OVERRIDES = {
        # Week 11 - John Deere Classic: No WDs yet
    }
